...
public class AdminProcess
{
   ...
   * 
   */
  private static final Logger LOGGER = LoggerFactory.getLogger(AdminProcess.class);
   ...
   * @return
   */
  private DbProfileData updateDbprofileData(DbProfileData profileData, SecUser secUser)
  {
